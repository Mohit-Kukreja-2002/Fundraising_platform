        ...
        <>
            ...
            <div className={`${count !== 2 ? "hidden" : ""} mb-[100px] mt-[72px] flex flex-col items-center justify-center`}>
                ...
                {benefitter === "myself" && <div className='items-center border-solid border-2 border-[#beb0b4] mb-20 rounded-3xl overflow-hidden shadow-2xl'>
                    <div className='p-3 bg-slate-200'>
                        <div className='relative w-20 h-20 m-auto'>
                            ...
                            <AiTwotonePlusCircle className="absolute bottom-0 right-0 m-0 text-[#9c3353]" />
                        </div>
                    </div>
                    <div className='p-4 px-20 pb-10 space-y-4 border-t border-b-0'>
                        <p> <span>I'm </span>
                            <input type="text" name="name" id="name" className='flex-1 py-1 text-gray-600 border-b-2 border-gray-400 outline-none' placeholder='  Name' />
                        </p>
                        <p>
                        ...
                        <div class="pt-6 grid w-[18rem] grid-cols-3 p-2" x-data="app">
                            <div>
                                <input checked type="radio" name="option" id="0" class="peer hidden" />
                                <label for="0" class="block cursor-pointer select-none p-2 text-center peer-checked:bg-[#9c3353] peer-checked:font-bold peer-checked:text-white">Male</label>
                            </div>
                            <div>
                                <input type="radio" name="option" id="1" class="peer hidden" />
                                <label for="1" class="block cursor-pointer select-none p-2 text-center peer-checked:bg-[#9c3353] peer-checked:font-bold peer-checked:text-white">Female</label>
                            </div>
                            <div>
                                <input type="radio" name="option" id="2" class="peer hidden" />
                                <label for="2" class="block cursor-pointer select-none p-2 text-center peer-checked:bg-[#9c3353] peer-checked:font-bold peer-checked:text-white">Other</label>
                            </div>
                        </div>
                        <br />
                        <p>I'm residing in <input type="text" name="city" id="city" className='flex-1 py-0 text-gray-600 border-b-2 border-gray-400 outline-none' /> </p>
                    </div>
                </div>}
                {/* Relative */}
                {benefitter === "my relative" && <div className='items-center border-solid border-2 border-[#beb0b4] mb-20 rounded-3xl overflow-hidden shadow-2xl'>
                    ...
                    <div className='items-center p-4 px-20 pb-10 space-y-4 border-t border-b-0'>
                        ...
                        <br />
                        <p>& residing in <input type="text" name="city" id="city" className='flex-1 py-0 text-gray-600 border-b-2 border-gray-400 outline-none' /> </p>
                    </div>
                ...
                {benefitter === "my friends" && <div className='items-center border-solid border-2 border-[#beb0b4] mb-20 rounded-3xl overflow-hidden shadow-2xl'>
                    ...
                    <div className='items-center p-4 px-20 pb-10 space-y-4 border-t border-b-0'>
                        ...
                        <br />
                        <div
                            class="grid w-[18rem] grid-cols-3 p-2"
                            x-data="app"
                        >
                            <div>
                                <input type="radio" name="option" id="0" class="peer hidden" checked />
                                <label for="0" class="block cursor-pointer select-none p-2 text-center peer-checked:bg-[#9c3353] peer-checked:font-bold peer-checked:text-white">Male</label>
                            </div>
                            <div>
                                <input type="radio" name="option" id="1" class="peer hidden" />
                ...
                {benefitter === "others" && <div className='items-center border-solid border-2 border-[#beb0b4] mb-20 rounded-3xl overflow-hidden shadow-2xl'>
                    ...
                    <div className='items-center p-4 px-20 pb-10 text-gray-400 border-t border-b-0'>
                        <p>Funds raised will help <input type="text" name="name" id="name" className='flex-1 py-0 text-gray-600 border-b-2 border-gray-400 outline-none' /> </p>
                        <p className='pt-3 my-8 ml-4'>based out of<input type="text" name="city" id="city" className='py-0 text-gray-600 border-b-2 border-gray-400 outline-none' /> </p>
                    </div>
                    <div className='p-4 px-20 bg-slate-200'>
                        <div className='border-b-2 border-gray-400'>
                            <BsFillTelephoneFill className='text-[#000000] inline' />
                ...
                {benefitter === "Registered NGO" && <div className='items-center border-solid border-2 border-[#beb0b4] mb-20 rounded-3xl overflow-hidden shadow-2xl'>
                    <div className='items-center p-4 px-20 pb-10 text-gray-400 border-t border-b-0'>
                        ...
                        <p>Funds raised will help <input type="text" name="name" id="name" className='flex-1 py-0 mt-4 text-gray-600 border-b-2 border-gray-400 outline-none' /> </p>
                        <p className='pt-3 my-6 ml-0'>based out of<input type="text" name="city" id="city" className='py-0 text-gray-600 border-b-2 border-gray-400 outline-none ' /> </p>
                    </div>
                </div>}
            </div >
            ...
            <div className={`${count !== 3 ? "hidden" : ""} mb-[100px] mt-[72px] flex flex-col items-center justify-center`}>
                ...
                {cause === "medical" && <div className='my-10 space-y-10 text-gray-500 w-[460px] '>
                    ...
                    <div className='space-y-4'>
                        ...
                        <input type="text" name="Hname" id="Hname" className='flex-1 py-0.5 border-b-2 border-gray-400 text-gray-400 outline-none w-full' placeholder='Hospital Name' />
                        <input type="text" name="Hloc" id="Hloc" className='flex-1 py-0.5 border-b-2 border-gray-400 text-gray-400 outline-none w-full' placeholder='Location (City) of the hospital' />
                        <input type="text" name="ailment" id="ailment" className='flex-1 py-0.5 border-b-2 border-gray-400 text-gray-400 outline-none w-full' placeholder='Ailment' />
                    </div>
                </div>}
            ...
            <div className={`${count !== 4 ? "hidden" : ""} mb-[100px] mt-[72px] flex flex-col items-center justify-center`}>
                ...
                <div className='mt-8 pb-16 p-8 w-[480px] items-center border-solid border-2 border-[#beb0b4] mb-10 rounded-3xl overflow-hidden shadow-2xl'>
                    <div>
                        ...
                        <input type="text" name="name" id="name" className='flex-1 w-full p-2 py-1 text-sm text-center text-gray-600 border-b-2 border-gray-400 outline-none align-centre' placeholder="Eg: Help Mohit in saving activa" />
                    </div>
            ...
            <div className='p-[0_50px] fixed bottom-0 w-[100%] z-[1000] '>
                <div className='max-h-[80px] p-[40px_10px] w-[60%] relative mx-auto bg-[linear-gradient(0deg,#9c3353,#5f2747)] flex items-center'>
                    ...
                    {count < 5 && <button onClick={() => handleCountIncreaseChange()} className='absolute rounded-full right-[40px] inline-block w-[120px] text-[#9c3353] py-2 bg-[#fff] text-[15px] '>Continue</button>}
